...
public class BubblesManager implements BubbleLayoutListener, TrashViewListener, ScreenChangedListener {
    ...
    @Override
    public void onTrashAnimationStarted(@BubbleTrash.AnimationState int animationCode) {
    }

    @Override
    public void onTrashAnimationEnd(@BubbleTrash.AnimationState int animationCode) {
    }
